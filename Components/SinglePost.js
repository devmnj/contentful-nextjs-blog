...
function Post(props) {
    // const text  =documentToReactComponents(props.content, options);
            ...
            <div className="   dark:bg-gray-800 max-w-6xl px-6 py-16 mx-auto space-y-12">
                <article className="  flex-col space-y-8 dark:bg-gray-800 dark:text-gray-50">
                    ...
                    <div className="dark:text-gray-100">
                        ...
                        <RichText document={props.content?.node}/>
                        <p>
    ...
    return (
        <>
            ...
            < Post title={props.post.fields.title} summary={props.post.fields.summary}
                   content={props.post.fields.content.content[0].content[0].value} 
                   image={props.post.fields.featuredImage.fields.file.url}/>
        </>
    );
}
